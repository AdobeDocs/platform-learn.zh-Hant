...
瞭解如何在資料收集中建立事件轉送屬性。 如需詳細資訊，請造訪 [建立事件轉送屬性檔案](https://experienceleague.adobe.com/docs/experience-platform/tags/event-forwarding/getting-started.html#create-an-event-forwarding-property).

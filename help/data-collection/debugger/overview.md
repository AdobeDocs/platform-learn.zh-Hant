...
瞭解Adobe Experience Platform Debugger [Chrome擴充功能](https://chrome.google.com/webstore/detail/adobe-experience-platform/bfnnokhpnncpkdmbokanobigaccjkpob)如何協助您針對Adobe Experience Platform Web SDK、AppMeasurement.js和at.js的實施進行偵錯，這些資料庫支援Real-Time CDP、Journey Optimizer、Customer Journey Analytics、Adobe Analytics、Adobe Target、Adobe Audience Manager、標籤等專案。

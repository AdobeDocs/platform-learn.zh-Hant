...
1. 記下&#x200B;**[!UICONTROL 金鑰識別碼]**。 它用於App Surface設定。
1. 記下&#x200B;**[!UICONTROL 團隊識別碼]**。 它用於App Surface設定。
...
1. 開啟&#x200B;**[!UICONTROL 推送認證]**&#x200B;切換以新增您的認證。
1. 拖放您的`.p8` **Apple推播通知驗證金鑰**&#x200B;檔案。
1. 提供&#x200B;**[!UICONTROL 金鑰識別碼]**，在建立`p8`驗證金鑰期間指派的10字元字串。 您可以在Apple開發人員入口網站頁面的&#x200B;**憑證、識別碼和設定檔**&#x200B;頁面的&#x200B;**[!UICONTROL 金鑰]**&#x200B;標籤下找到它。 另請參閱[建立私密金鑰](#create-a-private-key)。
1. 提供&#x200B;**[!UICONTROL 團隊識別碼]**。 可以在&#x200B;**成員資格**&#x200B;標籤下或Apple開發人員入口網站頁面頂端找到團隊ID的值。 另請參閱[建立私密金鑰](#create-a-private-key)。
1. 選取「**[!UICONTROL 儲存]**」。
...
1. 您的歷程應如下所示。 選取&#x200B;**[!UICONTROL Publish]**以發佈並啟用您的歷程。

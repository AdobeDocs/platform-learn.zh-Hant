...
* 檢視：當使用者檢視特定產品時發生，
* 加入購物車：當使用者在產品詳細資料畫面中點選![ShoppingCart](/help/assets/icons/ShoppingCart.svg)時，
* 儲存以供稍後使用：當使用者在產品詳細資料畫面中點選![心](/help/assets/icons/Heart.svg) / ![ThumbUp](/help/assets/icons/ThumbUp.svg)時，
* 購買：使用者在產品詳細資料畫面中點選![信用卡](/help/assets/icons/CreditCard.svg)時。
...
1. 導覽至Xcode專案導覽器中的&#x200B;**[!DNL Luma]** > **[!DNL Luma]** > **[!DNL Views]** > **[!DNL Products]** > **[!UICONTROL ProductView]**，並新增各種呼叫至`sendCommerceExperienceEvent`函式：
   ...
   1. 針對工具列中的每個按鈕（![心](/help/assets/icons/Heart.svg)、![購物車](/help/assets/icons/ShoppingCart.svg)和![信用卡](/help/assets/icons/CreditCard.svg)），在`ATTrackingManager.trackingAuthorizationStatus == .authorized`關閉中新增相關呼叫：

      1. 針對![心](/help/assets/icons/Heart.svg)：
      ...
      1. 針對![ShoppingCart](/help/assets/icons/ShoppingCart.svg)：
      ...
      1. 針對![信用卡](/help/assets/icons/CreditCard.svg)：
...
1. 導覽至Android Studio導覽器中的&#x200B;**[!UICONTROL 應用程式]** > **[!UICONTROL kotlin+java]** > **[!UICONTROL com.adobe.luma.tutorial.android]** > **[!UICONTROL 檢視]** > **[!UICONTROL ProductView.kt]**，並將各種呼叫新增至`sendCommerceExperienceEvent`函式：
   ...
   1. 針對工具列中的每個按鈕（![ThumbUp](/help/assets/icons/ThumbUp.svg)、![ShoppingCart](/help/assets/icons/ShoppingCart.svg)及![CreditCard](/help/assets/icons/CreditCard.svg)），在`scope.launch`的`if (MobileSDK.shared.trackingEnabled == TrackingStatus.AUTHORIZED)  statement`內新增相關呼叫：

      1. 針對![ThumbUp](/help/assets/icons/ThumbUp.svg)：
...
1. 檢閱[設定指示](assurance.md#connecting-to-a-session)區段，將您的模擬器或裝置與Assurance連線。
   ...
   1. 選取產品。
   1. 選取![心臟](/help/assets/icons/Heart.svg) (iOS)或![ThumbUp](/help/assets/icons/ThumbUp.svg) (Android)。
   1. 選取「![購物車新增](/help/assets/icons/ShoppingCart.svg)」。
   1. 選取![信用卡](/help/assets/icons/CreditCard.svg)。

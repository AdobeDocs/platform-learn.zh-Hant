...
Adobe已將一組&#x200B;**Adobe定義的函式**&#x200B;新增至標準SQL語法，讓您更清楚瞭解您的體驗資料。 在接下來的幾個查詢中，您將瞭解這些ADF函式。 您可以在檔案[&#128279;](https://experienceleague.adobe.com/docs/experience-platform/query/sql/adobe-defined-functions.html?lang=zh-Hant)中找到詳細資訊和完整清單。

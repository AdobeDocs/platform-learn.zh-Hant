...
讓我們使用您在Analysis Workspace[的](./ex4.md)1.1.4資料準備中建立的專案，請移至[https://analytics.adobe.com](https://analytics.adobe.com)。
...
有了第一個流量分析，我想到了一個新問題。 因此，我們決定建立此表格，並針對區段檢查某些KPI，以回答此問題。 如您所見，前往insight的時間比使用SQL或其他BI解決方案快得多。

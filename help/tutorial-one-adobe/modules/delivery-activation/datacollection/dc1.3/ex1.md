...
### 資料表`--aepUserLdap--_PERSONS`

按一下&#x200B;**+建立**，然後按一下&#x200B;**表格**，再按一下&#x200B;**標準**。

![FAC](./images/tb1.png)

您將會看到此訊息。 複製以下查詢並將其貼到Snowflake中。 在建立表格之前，請務必選取畫面左上角的&#x200B;**CITISIGNAL**&#x200B;資料庫。
...
### 資料表`--aepUserLdap--_MONTHLY_DATA_USAGE`
...
### 資料表`--aepUserLdap--_MOBILE_DATA_USAGE`
...
您應該會看到此訊息。 按一下以開啟&#x200B;**下拉式清單**，然後選取&#x200B;**全部執行**&#x200B;以執行所有查詢。
...
您現在已將示範資料載入您的Snowflake資料庫。 您可以透過開啟任何表格來探索其中的資料
...
移至[1.3.2建立結構描述、資料模型和連結](./ex2.md){target="_blank"}

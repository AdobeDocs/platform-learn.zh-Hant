...
# 3.3.3為Offer Decisioning準備Adobe Experience Platform資料收集使用者端屬性和Web SDK設定

## 3.3.3.1更新您的資料流

在[快速入門](./../../../../modules/getting-started/gettingstarted/ex2.md)中，您已建立自己的&#x200B;**資料流**。 您接著使用名稱`--aepUserLdap-- - Demo System Datastream`。

在本練習中，您需要設定&#x200B;**資料串流**&#x200B;以搭配&#x200B;**Offer Decisioning**&#x200B;使用。
...
若要啟用&#x200B;**Offer Decisioning**，請勾選&#x200B;**Offer Decisioning**&#x200B;的方塊。 按一下&#x200B;**儲存**。

![WebSDK](./images/websdk5.png)

您的&#x200B;**資料串流**&#x200B;現在已準備好與&#x200B;**Offer Decisioning**&#x200B;搭配使用。
...
每次您現在載入&#x200B;**一般頁面**&#x200B;時（例如示範網站的首頁），Offer Decisioning都會評估適用的選件，並傳回回應給網站，其中包含要顯示的選件詳細資料。 在網站上顯示選件需要其他設定，您將在下一個步驟中進行。
...
經過此變更後，Adobe Experience Platform資料收集中的此規則現在會聆聽Offer Decisioning的回應(屬於Web SDK回應的一部分)，而收到回應時，會在首頁上顯示選件的影像。
...
- 1 Offer Decisioning實作（使用您的資料收集屬性）

在下一個練習中，您將瞭解如何將在Adobe Journey Optimizer中建立的優惠和決定與Adobe Target體驗鎖定目標活動結合。

## 後續步驟

移至[3.3.4將Adobe Target與Offer Decisioning結合](./ex4.md){target="_blank"}

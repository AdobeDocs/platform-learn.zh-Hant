...
在本練習中，您將再次使用Adobe I/O來查詢Adobe Experience Platform的API。如果您尚未設定Adobe I/O專案，請回到單元2.1[中的](../rtcdpb2c-1/ex3.md)練習3，並遵循其中的指示。
...
在本練習中，您將再次使用Postman來查詢Adobe Experience Platform的API。如果您尚未設定Postman應用程式，請回到模組2.1[中的](../rtcdpb2c-1/ex3.md)練習3，並遵循其中的指示。

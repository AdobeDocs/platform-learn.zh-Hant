---
title: Audience Activation至Microsoft Azure活動中心
description: Audience Activation至Microsoft Azure活動中心
kt: 5342
doc-type: tutorial
...
在本單元中，您將設定Microsoft Azure EventHub目的地為Adobe Experience Platform Real-time CDP的即時目的地。 您也可以設定和部署Azure函式，每當Adobe Experience Platform將對象裝載傳送至Azure EventHub目的地時，就會即時觸發。 您將觸發的Azure函式將會顯示Adobe Experience Platform Real-time CDP啟用功能的機制。
...
Microsoft Azure事件中樞是完整受管的即時資料擷取服務，簡單、信任且可擴充。 每秒從任何來源串流數百萬個事件以建置動態資料管道，並立即回應業務挑戰。

## 學習目標

- 熟悉Microsoft Azure活動中心
- 設定RTCDP目的地至您的Microsoft Azure事件中心
- 瞭解Real-time CDP何時啟用，以及啟用裝載的外觀
- 設定Visual Studio Code以開發、測試和部署您的Azure專案
- 建立及部署Azure功能，該功能採用RTCDP即時提供的受眾資格
...
在本練習中，您將設定Microsoft Azure EventHub環境。
...
在本練習中，您將建立Azure函式，當Adobe Experience Platform將對象資格提供給相對應的Azure事件中樞目的地時，就會即時觸發。

...
為了將這些變數與AEM Assets Dynamic Media搭配使用，每個城市的圖層都應匯出為影像。 若要這麼做，請移至&#x200B;**檔案** > **匯出** > **圖層至檔案……**。

![AEM Assets Dynamic Media](./images/aemdm4.png)

您應該會看到類似這樣的內容。 選取要匯出檔案的位置，選取檔案型別&#x200B;**PNG-8**，然後按一下&#x200B;**執行**。

![AEM Assets Dynamic Media](./images/aemdm5.png)

幾秒後，您應該會看到此訊息。 按一下&#x200B;**「確定」**。
...
您的Dynamic Media範本現在已成功設定。 在下一個練習中，您會將該範本與Adobe Journey Optimizer中的電子郵件行銷活動搭配使用。

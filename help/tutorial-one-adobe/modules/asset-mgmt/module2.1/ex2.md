...
釘選&#x200B;**AEM Sidekick**&#x200B;延伸模組。

![AEMCS](./images/aemdocbcssetup17.png){zoomable="yes"}

## 1.1.2.5預覽和發佈檔案式網站

返回Google Drive資料夾。 在工作列中，按一下&#x200B;**AEM Sidekick**&#x200B;擴充功能。 接著，您會在資料夾上看到AEM Sidekick列快顯視窗。
...
再次選取Google Drive資料夾中的3個檔案。 現在，按一下&#x200B;**發佈**。

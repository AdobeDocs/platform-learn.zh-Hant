...
>[!IMPORTANT]
>
>您的AEM CS沙箱可能已休眠。 鑑於讓沙箱解除休眠需要10-15分鐘，最好現在開始解除休眠過程，這樣以後就不必等待了。
...
按一下以開啟您的Cloud Manager程式，該程式應使用下列命名選項：
...
在此範例中，將會使用方案&#x200B;**技術內部人士 — AEM + ACCS 100**。 您應該使用自己的程式。
...
在&#x200B;**標題**&#x200B;欄位中，輸入： `--aepUserLdap-- - CitiSignal`。 按一下&#x200B;**建立**。

![AEM代理程式](./images/aemagents6.png)

按一下名稱空間&#x200B;**`--aepUserLdap-- - CitiSignal`**&#x200B;以深入鑽研它。 按一下[建立]****，然後選取[建立標籤]****。

![AEM代理程式](./images/aemagents7.png)

在&#x200B;**標題**&#x200B;欄位中，輸入： `--aepUserLdap-- - Campaign`。 按一下&#x200B;**提交**。

![AEM代理程式](./images/aemagents8.png)

按一下標籤&#x200B;**`--aepUserLdap-- - Campaign`**&#x200B;以選取它。 按一下[建立]****，然後選取[建立標籤]****。

![AEM代理程式](./images/aemagents9.png)

在&#x200B;**標題**&#x200B;欄位中，輸入： `--aepUserLdap-- - Winter 2026`。 按一下&#x200B;**提交**。
...
在&#x200B;**標題**&#x200B;欄位中，輸入： `--aepUserLdap-- - Spring 2026`。 按一下&#x200B;**提交**。
...
選取第一個影像(citisignal_lion.png)，然後按一下&#x200B;**屬性**。
...
選取標籤&#x200B;**`--aepUserLdap-- - Spring 2026`**&#x200B;並按一下&#x200B;**選取**。

![AEM代理程式](./images/aemagents23.png)

按一下「**儲存並關閉**」。

![AEM代理程式](./images/aemagents23a.png)
...
您可以嘗試其他提示。 向上捲動並選取其他建議的提示之一，或輸入您自己的提示，然後按一下&#x200B;**傳送**。

`For the first image, generate a mirrored image`

![AEM代理程式](./images/aemagents42a.png)

檢閱產生的影像。

![AEM代理程式](./images/aemagents42b.png)
...
在使用Edge Delivery Services](./../../asset-mgmt/module1.3/aemforms.md){target="_blank"}的模組[Adobe Experience Manager Forms中，您可以找到以手動方式建立表單的相關步驟。

---
title: AI助理與Agent Orchestrator
description: AI助理與Agent Orchestrator
kt: 5342
doc-type: tutorial
...
您應該會看到此訊息。 確定您隸屬於組織`--aepImsOrgName--`。
...
您現在想要檢視您的所有對象，以及這些對象在過去幾天內的變更程度。
...
移至ChatGPT Enterprise的[Adobe Marketing Agent](./ex2.md){target="_blank"}

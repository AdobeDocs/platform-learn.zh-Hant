...
讓我們使用您在Analysis Workspace](./ex4.md)的[4.4資料準備中建立的專案，請移至[https://analytics.adobe.com](https://analytics.adobe.com)。

![示範](./images/prohome.png)

開啟您的專案`yourLastName - Omnichannel Analysis`。

開啟專案並選取資料檢視`CJA Bootcamp - Omnichannel Data View`後，您就可以開始建立第一個視覺效果了。
...
>[!IMPORTANT]
>
>最新的可用資料已於2022年9月19日擷取，請選取包含此日期的日期範圍。
...
讓我們開始找出檢視的前4大產品。 在左側功能表中，尋找&#x200B;**產品名稱** -Dimension。
...
接下來，在表格中，從我們在&#x200B;**Google Pixel XL 32GB黑色智慧型手機** > **花旗訊號**&#x200B;下進行的劃分中，選取3 **忠誠度等級**&#x200B;列。 選取3列時，按住&#x200B;**CTRL**&#x200B;按鈕（在Windows上）或&#x200B;**Command**&#x200B;按鈕(在Mac上)。

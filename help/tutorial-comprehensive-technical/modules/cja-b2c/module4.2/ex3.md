...
| 命名 | 範例 |
| ----------------- |-------------| 
| `--demoProfileLdap-- - AEP BigQuery Connector` | vangeluw - AEP BigQuery聯結器 |
...
| BigQuery聯結器認證 | 值 | 範例 |
| ----------------- |-------------| -------------| 
| 帳戶名稱 | `--demoProfileLdap-- - BigQuery Connection` | vangeluw - BigQuery Connection |
| 說明 | `--demoProfileLdap-- - BigQuery Connection` | vangeluw - BigQuery Connection |

...
在本練習中，您將再次使用Adobe I/O來查詢Adobe Experience Platform的API。如果您尚未設定Adobe I/O專案，請回到模組2.1[&#128279;](../module2.1/ex3.md)中的練習3，並遵循其中的指示。
...
在本練習中，您將再次使用Postman來查詢Adobe Experience Platform的API。如果您尚未設定Postman應用程式，請回到模組2.1[&#128279;](../module2.1/ex3.md)中的練習3，並遵循其中的指示。
...
>[!NOTE]
>
>如果您沒有Postman集合，請回到模組2.1[&#128279;](../module2.1/ex3.md)中的練習3，並依照這裡的指示設定Postman與提供的Postman集合。

...
在欄位&#x200B;**endUserIDs的右側功能表中。_experience.emailid.id**，向下捲動並核取&#x200B;**身分**&#x200B;的核取方塊，核取&#x200B;**主要身分**&#x200B;的核取方塊，並選取&#x200B;**電子郵件**&#x200B;的&#x200B;**身分名稱空間**。 按一下&#x200B;**套用**。
...
您就會擁有此專案。 接著，選取結構描述的名稱。 您現在應該按一下&#x200B;**設定檔**&#x200B;切換按鈕，為&#x200B;**設定檔**&#x200B;啟用結構描述。

...
+ Real-Time CDP簡介 {#rtcdp}
   + [簡短概述](rtcdp/understanding-the-real-time-customer-data-platform.md)
   + [如何使用Real-Time CDP](rtcdp/understanding-the-real-time-customer-data-platform-user-interface.md)
   + [端對端示範](rtcdp/demo.md)
   + [B2B edition概觀](rtcdp/b2b-overview.md)
   + [使用Marketo Engage協調行銷活動](rtcdp/orchestrate-campaigns-with-marketo-engage.md)
+ [快速入門：資料架構師和資料工程師](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ 管理 {#admin}
   ...
   + [將使用者新增至資料收集](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/data-collection/users-and-permissions)
...
+ AI 助理 {#ai-assistant}
   ...
   + [Agent Orchestrator介面](/help/platform/ai-assistant/agent-orchestrator-ui.md)
   ...
   + [產品支援代理](/help/platform/ai-assistant/product-support-agent.md)
   ...
   + [運作洞察](/help/platform/ai-assistant/operational-insights.md)
   + [影響分析](/help/platform/ai-assistant/impact-analysis.md)
   + [AI 點數](/help/platform/ai-assistant/ai-credits.md)
   + [安全性概覽](/help/platform/ai-assistant/security-overview.md)
+ API {#api}
   + [驗證Experience Platform API](/help/platform/api/platform-api-authentication.md)
   + [產生存取權杖](/help/platform/api/generate-an-access-token.md)
   + [使用API](/help/platform/api/use-apis-with-postman.md)
+ 對象與細分 {#audiences}
   + 對象產生器{#audience-builder}
      + [簡介](audiences/audience-builder/introduction-to-audience-portal-and-composition.md)
      + [上傳對象](audiences/audience-builder/upload-audiences.md)
      + [對象規則產生器概觀](audiences/audience-builder/audience-rule-builder-overview.md)
      + [建立客群](audiences/audience-builder/create-audiences.md)
   ...
   + 聯合客群構成 {#fac}
      ...
      + [建立同盟對象](audiences/fac/create-a-federated-audience-composition.md)
      + [訂閱警報](audiences/fac/subscribe-to-alerts.md)
   + 區段比對{#segment-match}
      + [區段比對連線設定](/help/platform/audiences/segment-match/segment-match-connection-setup.md)
      + [區段比對資料治理](/help/platform/audiences/segment-match/segment-match-data-governance.md)
      + [區段比對設定流程](/help/platform/audiences/segment-match/segment-match-configuration-flow.md)
   ...
   + 教學課程{#audience-tutorials}
      + [評估對象規則](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/segmentation/tutorials/evaluate-a-segment){target="_blank"}
      + [建立資料集以匯出資料](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/segmentation/tutorials/create-dataset-export-segment){target="_blank"}
      + [與資料倉儲中的對象互動](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview){target="_blank"}
+ [稽核記錄](/help/platform/governance/audit-logs.md)
+ [資料彙集](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/data-collection/overview){target="_blank"}
+ 共同作業 {#collaboration}
   ...
   + [適用於代理商從業人員的Real-Time CDP概觀](collaboration/rtcdp-overview-for-agency-practitioners.md)
   + [Collaboration — 流程和人員](collaboration/rtcdp-collaboration-process-and-people.md)
   ...
   + [建立專案](collaboration/create-a-project.md)
   + [探索對象重疊](collaboration/discover-audience-overlaps-in-projects.md)
   + [對共同作業人員啟用對象](collaboration/activate-audiences-in-projects.md)
   + [Collaboration測量 — 設定和建立報告](collaboration/collaboration-measurement-setup-and-report-creation.md)
   + [品牌對品牌](collaboration/brand-to-brand-collaboration.md)
   + [邀請合作夥伴使用Collaboration](collaboration/rtcdp-collaboration-in-product-invitations.md)
+ 儀表板 {#dashboards}
...
+ 資料攝取 {#data-ingestion}
   ...
   + [批次攝取概觀](/help/platform/data-ingestion/batch-ingestion-overview.md)
   ...
   + [將CSV檔案對應至XDM](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/ingestion/tutorials/map-csv/existing-schema){target="_blank"}
   + [來源概觀](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/overview)
   + [從Adobe Analytics擷取資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics)
   + [從Audience Manager擷取資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-aam)
   + [從雲端儲存空間擷取資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage)
   + [從CRM擷取資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-crm)
   + [從資料庫擷取資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-databases)
   + [串流攝取概觀](/help/platform/data-ingestion/understanding-streaming-ingestion.md)
   + [使用HTTP API串流資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [使用Source聯結器串流資料](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
   + [Web SDK教學課程](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/data-collection/web-sdk/overview){target="_blank"}
   + [Mobile SDK教學課程](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/data-collection/mobile-sdk/overview){target="_blank"}
...
+ 目的地 {#destinations}
   ...
   + [對目的地啟用設定檔和對象](/help/platform/destinations/activate-profiles-and-segments-to-a-destination.md)
   + [使用雲端儲存空間目的地匯出資料集](/help/platform/destinations/configure-dataset-export-destination.md)
   + [與Google Customer Match整合](/help/platform/destinations/integrate-with-google-customer-match.md)
   + [設定Azure Blob目的地](/help/platform/destinations/configure-the-azure-blob-destination.md)
   + [設定Marketo Engage目的地](/help/platform/destinations/configure-the-marketo-destination.md)
   ...
   + Data Warehouse {#data-warehouse}
      + [將受眾資料傳送至Snowflake資料共用批次](/help/platform/destinations/data-warehouse/send-audience-data-snowflake-batch.md)
   + Adobe Target和自訂Personalization{#target}
      ...
      + [啟動區段和輪廓屬性](/help/platform/destinations/target/activate-segments-and-profile-attributes.md)
...
+ 身分識別 {#identities}
   ...
   + 身分識別圖連結規則 {#graph-linking-rules}
      ...
      + [身分設定](/help/platform/identities/identity-graph-linking-rules/identity-settings.md)
+ Intelligent Services {#intelligent-services}
   + [概觀](/help/platform/intelligent-services/introduction-to-intelligent-services.md)
   + [Attribution AI 概觀](/help/platform/intelligent-services/introduction-to-attribution-ai.md)
   ...
   + [使用 Attribution AI 評分和洞察](/help/platform/intelligent-services/use-attribution-ai-scores-and-insights.md)
   + [Customer AI 概觀](/help/platform/intelligent-services/introduction-to-customer-ai.md)
   ...
   + [使用 Customer AI 評分和洞察](/help/platform/intelligent-services/use-customer-ai-scores-and-insights.md)
+ 監控 {#monitoring}
   ...
   + [串流容量管理](monitoring/streaming-management.md)
   + [整合Slack](monitoring/monitor-events-in-slack.md)
...
+ 輪廓 {#profiles}
   ...
   + [自訂設定檔檢視詳細資料](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/profile/ui/profile-customization){target="_blank"}
...
+ 查詢與資料Distiller {#queries}
   + [概觀](/help/platform/queries/understanding-query-service.md)
   + [執行查詢](/help/platform/queries/run-queries.md)
   + [驗證資料](/help/platform/queries/explore-data.md)
   + [衍生資料](/help/platform/queries/prepare-data.md)
   ...
   + [連線Tableau](/help/platform/queries/psql-client-tableau.md)
   + [在Tableau中分析和視覺化資料](/help/platform/queries/analyze-and-visualize.md)
...
+ 結構描述 {#schemas}
   ...
   + [建立資料型別](/help/platform/schemas/create-data-types.md)
   + [設定方案之間的關係](/help/platform/schemas/configure-relationships-between-schemas.md)
   ...
   + [建立臨時結構描述](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/tutorials/ad-hoc){target="_blank"}
+ 來源 {#sources}
   + [概觀](/help/platform/sources/overview.md)
   + [從Adobe Analytics擷取資料](/help/platform/sources/ingest-data-from-adobe-analytics.md)
   + [從Audience Manager擷取資料](/help/platform/sources/ingest-data-from-aam.md)
   + [從Marketo擷取資料](/help/platform/sources/ingest-data-from-marketo.md)
   + [從雲端儲存空間擷取資料](/help/platform/sources/ingest-data-from-cloud-storage.md)
   + [從CRM擷取資料](/help/platform/sources/ingest-data-from-crm.md)
   ...
   + [使用Source聯結器串流資料](/help/platform/sources/streaming-ingestion-source-connector.md)
...
+ Experience Cloud 整合 {#experience-cloud}
   + [Analytics](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics)
   + [Audience Manager](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/sources/ingest-data-from-aam)
   + [Commerce](/help/platform/experience-cloud/business-value-of-platform-and-commerce.md)
   + [Marketo Engage](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/rtcdp/orchestrate-campaigns-with-marketo-engage)

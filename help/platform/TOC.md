...
+ AI 助理 {#ai-assistant}
   ...
   + [Data Insights Agent](https://experienceleague.adobe.com/zh-hant/docs/customer-journey-analytics-learn/tutorials/data-insights-agent/introduction-to-the-data-insights-agent)
...
+ 查詢與資料Distiller {#queries}
   ...
   + [準備資料](/help/platform/queries/prepare-data.md)
   ...
   + [從查詢結果產生資料集](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/query/ui/create-datasets){target="_blank"}
   ...
   + [將使用者端連線至查詢服務](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/query/clients/overview){target="_blank"}

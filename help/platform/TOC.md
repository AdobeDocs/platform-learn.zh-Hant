...
+ [快速入門：資料架構師和資料工程師](https://experienceleague.adobe.com/en/docs/platform-learn/getting-started-for-data-architects-and-data-engineers/overview){target="_blank"}
...
+ 管理 {#admin}
   ...
   + [將使用者新增至資料收集](https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/users-and-permissions)
...
+ [資料彙集](https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/overview){target="_blank"}
+ 共同作業 {#collaboration}
...
+ 資料攝取 {#data-ingestion}
   ...
   + [使用HTTP API串流資料](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api)
   + [使用Source聯結器串流資料](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector)
   + [Web SDK教學課程](https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/web-sdk/overview){target="_blank"}

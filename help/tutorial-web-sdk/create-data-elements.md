...
瞭解如何在[Luma示範網站](https://luma.enablementadobe.com)的內容、商務和身分資料的標籤中建立資料元素。 然後填入XDM結構描述中的欄位。
...
>[!IMPORTANT]
>
>此課程的資料來自`[!UICONTROL adobeDataLayer]`Luma網站[上的](https://luma.enablementadobe.com)資料層。 若要檢視資料層，請開啟您的開發人員主控台，並輸入`[!UICONTROL adobeDataLayer]`以檢視可用的完整資料層。![adobeDataLayer資料層](assets/data-element-data-layer-new.png)

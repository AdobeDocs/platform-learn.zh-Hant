...
1. 請依照步驟[將](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property)Luma示範網站[上的標籤庫](https://newluma.enablementadobe.com/category-men.html)切換為您在資料流中將事件轉送屬性對應到的Web SDK標籤屬性。

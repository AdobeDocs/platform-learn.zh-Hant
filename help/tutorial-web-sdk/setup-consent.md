...
1. 在Experience Platform Web SDK標籤擴充功能的&#x200B;**[!UICONTROL 同意]**&#x200B;區段中，確認&#x200B;**[!UICONTROL 預設同意]**&#x200B;設為&#x200B;**[!UICONTROL In]**：
...
5. 透過此設定，Experience Platform Web SDK擴充功能會向Platform Edge Network提出網路要求，直到訪客決定拒絕Cookie並退出為止：
...
1. 做為&#x200B;**[!UICONTROL 動作]**，請使用Experience Platform Web SDK擴充功能，[!UICONTROL 設定同意] [!UICONTROL 動作型別]，將同意設定為「out」：
...
1. 在Experience Platform Web SDK擴充功能的&#x200B;**[!UICONTROL 同意]**&#x200B;區段中，視需要設定預設同意為&#x200B;**[!UICONTROL Out]**&#x200B;或&#x200B;**[!UICONTROL 擱置中]**。

1. **儲存**&#x200B;更新的設定到您的標籤程式庫並重新建置。

   ![AEP擴充功能同意設定](assets/consent-implied-opt-out.png)
...
如需在網頁SDK中同意的詳細資訊，請參閱[支援客戶同意偏好設定](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/edge/consent/supporting-consent)。

...
1. 前往[Luma示範網站](https://luma.enablementadobe.com){target="_blank"}
...
您在上方設定了[Luma首頁](https://luma.enablementadobe.com)的資料流覆寫。  驗證此設定的方式
...
移至[Livingston All-Purpose Tight product page](https://luma.enablementadobe.com/product.html?id=LLMP09)等產品頁面。  驗證Analytics是否擷取內容頁面檢視。
...
1. 將[Marco輕量型主動式連帽上衣](https://luma.enablementadobe.com/product.html?id=LLMH13)加入購物車
1. 前往[購物車頁面](https://luma.enablementadobe.com/cart.html)，檢查Edge追蹤

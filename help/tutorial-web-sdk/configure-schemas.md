...
這是Adobe的[體驗資料模型](https://business.adobe.com/products/experience-platform/experience-data-model.html)的目標。 XDM為業界常見的資料提供規範性模型，同時允許您擴充模型以滿足特定需求。 Adobe Experience Platform是圍繞XDM建置的，因此，傳送至Experience Platform的資料需要採用XDM。 您不必考慮在傳送資料至Experience Platform之前，要在哪裡以及如何將目前的資料模型轉換為XDM，請考慮更普遍地在組織內採用XDM，以便幾乎不需要進行翻譯。

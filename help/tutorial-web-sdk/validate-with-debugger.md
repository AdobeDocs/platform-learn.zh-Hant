...
在本課程中，您使用[Adobe Experience Platform Debugger擴充功能](https://chromewebstore.google.com/detail/adobe-experience-platform/bfnnokhpnncpkdmbokanobigaccjkpob)，將[Luma示範網站](https://newluma.enablementadobe.com)上以硬式編碼撰寫的標籤屬性取代為您自己的屬性。
...
您熟悉資料收集標籤和[Luma示範網站](https://newluma.enablementadobe.com/){target="_blank"}，並已完成教學課程中先前的課程：
...
1. 確定您已開啟[Luma示範網站](https://newluma.enablementadobe.com){target="_blank"}，並選取Experience Platform Debugger擴充功能圖示
...
1. 返回 [Luma 首頁](https://newluma.enablementadobe.com)
...
1. 重新整理[Luma首頁](https://newluma.enablementadobe.com/)並再次檢查&#x200B;**[!UICONTROL Experience Platform Debugger]**，檢視是否有資料傳入。

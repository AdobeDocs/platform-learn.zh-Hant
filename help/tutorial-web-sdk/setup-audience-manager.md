...
1. 開啟[Luma首頁](https://luma.enablementadobe.com) （對應至您的標籤屬性）和&#x200B;**Adobe Experience Platform Debugger**，然後重新整理頁面。
...
1. 開啟[Luma示範網站首頁](https://luma.enablementadobe.com)，並使其對應至您的標籤屬性，以符合您新建立區段的資格。

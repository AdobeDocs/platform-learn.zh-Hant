...
>[!NOTE]
>
>此教學課程使用[Luma網站](https://luma.enablementadobe.com){target=_blank}，該網站已採用非同步實作標籤並具備閃爍緩解功能。 本節內容僅供瞭解閃爍緩解如何與Platform Web SDK搭配運作之用。
...
1. 導覽至[Luma示範網站](https://luma.enablementadobe.com)
1. 導覽至產品詳細資料頁面
